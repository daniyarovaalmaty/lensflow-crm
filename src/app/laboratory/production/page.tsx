...
import { Clock, CheckCircle, TruckIcon, Package, Printer, User, Search, X, Calendar, SlidersHorizontal, AlertTriangle, Ban, RotateCcw, Eye, ChevronDown, DollarSign, Zap, Truck, MapPin, Download, FileText, Paperclip, CheckSquare, Square, Tag, Trash2, MessageCircle, Send, XCircle, Slash, FileEdit, Copy, RefreshCw } from 'lucide-react';
                                        ...
                                        onClick={() => {
                                            import('@/lib/generateInvoicePdf').then(({ generateInvoicePdf }) => {
                                                generateInvoicePdf({
                                                    ...
                                                    contract: order.contract as any,
                                                    optic_inn: order.inn,
