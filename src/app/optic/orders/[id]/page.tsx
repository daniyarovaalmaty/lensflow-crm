                        ...
                        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
                            ...
                            {(od || os) ? (
                                <div className="space-y-4">
                                    {od?.characteristic && <ReadOnlyEyeCard eye="od" label="OD (Правый глаз)" config={od} qty={Number(od.qty || 1)} />}
                                    {os?.characteristic && <ReadOnlyEyeCard eye="os" label="OS (Левый глаз)" config={os} qty={Number(os.qty || 1)} />}
                                </div>
                            ) : (
