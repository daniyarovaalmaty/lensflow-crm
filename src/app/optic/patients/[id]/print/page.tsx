...
export default async function FullPatientMedicalCardPrintPage({ params }: { params: { id: string } }) {
    ...
    const savedExam: PrimaryExamData = {
        ...
        visUncorrected: (rawSavedExam?.visUncorrected && hasTableData(rawSavedExam.visUncorrected))
            ...
            : { odDistance: latestConsultation?.visualAcuityOD ? String(latestConsultation.visualAcuityOD) : '', osDistance: latestConsultation?.visualAcuityOS ? String(latestConsultation.visualAcuityOS) : '', dominantEye: '' },
        ...
        eccentricity: (rawSavedExam?.eccentricity && hasTableData(rawSavedExam.eccentricity))
            ...
            : { odHoriz: latestConsultation?.eccentricityOD ? String(latestConsultation.eccentricityOD) : '', odVert: '', osHoriz: latestConsultation?.eccentricityOS ? String(latestConsultation.eccentricityOS) : '', osVert: '' },
        ...
        biomicroscopy: typeof rawSavedExam.biomicroscopy === 'string' && rawSavedExam.biomicroscopy.trim()
            ...
            : ((latestConsultation as any)?.biomicroscopy || ''),
