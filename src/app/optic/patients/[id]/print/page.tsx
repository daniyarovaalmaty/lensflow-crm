...
export default async function FullPatientMedicalCardPrintPage({ params }: { params: { id: string } }) {
    ...
    const savedExam: PrimaryExamData = {
        ...
        keratometry: (rawSavedExam?.keratometry && hasTableData(rawSavedExam.keratometry))
            ...
            : (latestConsultation?.k1OD || latestConsultation?.k1OS ? {
                odK1: latestConsultation.k1OD ? String(latestConsultation.k1OD) : '42.29',
                odK2: latestConsultation.k2OD ? String(latestConsultation.k2OD) : '43.92',
                osK1: latestConsultation.k1OS ? String(latestConsultation.k1OS) : '42.61',
                osK2: latestConsultation.k2OS ? String(latestConsultation.k2OS) : '44.50',
        ...
        visUncorrected: (rawSavedExam?.visUncorrected && hasTableData(rawSavedExam.visUncorrected))
            ...
            : { odDistance: latestConsultation?.visualAcuityOD ? String(latestConsultation.visualAcuityOD) : '0.1', osDistance: latestConsultation?.visualAcuityOS ? String(latestConsultation.visualAcuityOS) : '0.1', dominantEye: 'OD' },
        ...
        eccentricity: (rawSavedExam?.eccentricity && hasTableData(rawSavedExam.eccentricity))
            ...
            : { odHoriz: latestConsultation?.eccentricityOD ? String(latestConsultation.eccentricityOD) : '0.61', odVert: '0.68', osHoriz: latestConsultation?.eccentricityOS ? String(latestConsultation.eccentricityOS) : '0.55', osVert: '0.69' },
        ...
        diagnosis: rawSavedExam.diagnosis || latestConsultation?.diagnosis || 'OU - Миопия средней степени. Сложный миопический астигматизм.',
        recommendations: rawSavedExam.recommendations || latestConsultation?.treatment || 'Циклоскопия 1 раз в год. Оптическая биометрия раз в 6 месяцев.'
    };
