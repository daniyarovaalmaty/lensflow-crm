...
export async function POST(req: NextRequest) {
    ...
    const product = await prisma.opticProduct.create({
        data: {
            ...
            sku: body.sku === '' ? null : (body.sku || null),
            barcode: body.barcode === '' ? null : (body.barcode || null),
            ...
            isMedical: Boolean(body.isMedical),
            certNumber: body.certNumber || null,
            certUntil: body.certUntil ? new Date(body.certUntil) : null,
