...
export async function PUT(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
    ...
    const updated = await prisma.opticProduct.update({
        ...
        data: {
            ...
            sku: body.sku === '' ? null : (body.sku !== undefined ? body.sku : existing.sku),
            barcode: body.barcode === '' ? null : (body.barcode !== undefined ? body.barcode : existing.barcode),
            ...
            shelfLocation: body.shelfLocation !== undefined ? (body.shelfLocation || null) : existing.shelfLocation,
            isMedical: body.isMedical !== undefined ? Boolean(body.isMedical) : existing.isMedical,
            certNumber: body.certNumber !== undefined ? (body.certNumber || null) : existing.certNumber,
            certUntil: body.certUntil !== undefined ? (body.certUntil ? new Date(body.certUntil) : null) : existing.certUntil,
