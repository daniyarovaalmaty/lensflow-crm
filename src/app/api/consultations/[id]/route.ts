...
export async function PUT(request: Request, { params }: { params: { id: string } }) {
    ...
    const updated = await prisma.consultation.update({
        ...
        data: {
            ...
            r1OD: body.r1OD ? parseFloat(body.r1OD) : null,
            r2OD: body.r2OD ? parseFloat(body.r2OD) : null,
            ...
            r1OS: body.r1OS ? parseFloat(body.r1OS) : null,
            r2OS: body.r2OS ? parseFloat(body.r2OS) : null,
