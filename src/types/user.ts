...
export const DefaultClinicPermissions: Record<SubRole, ClinicPermissions> = {
    ...
    sales_manager: { canViewPos: true, canViewWarehouse: true, canViewCatalog: true, canViewCash: true, canViewPatients: true, canViewFinance: true, canViewOrders: true, canViewCrm: true, canViewTransfers: false, canViewNews: false, canViewBooking: true, canViewTasks: false, canViewAnalytics: false, canViewIssue: false, canViewRepairs: false, canViewReworks: false, canViewSupplierOrders: false },
...
export function getEffectiveClinicPermissions(user: { subRole: string; permissions?: any }): ClinicPermissions {
    ...
    return {
        ...
        canViewTransfers: typeof p.canViewTransfers === 'boolean' ? p.canViewTransfers : roleDefault.canViewTransfers,
        canViewNews: typeof p.canViewNews === 'boolean' ? p.canViewNews : roleDefault.canViewNews,
